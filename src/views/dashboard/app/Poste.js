...
function Poste(props) {
 ...
 function getReagirByUserandPost(){
  request.getReagir(data.id,post).then((result)=>{
    if(result!=null && result!=undefined){ setreagirState(true);}
    else{setreagirState(false);}
  })
 }
  return (
    <Card>
                      ...
                      <div className="d-flex flex-wrap justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                          <div className="d-flex align-items-center message-icon me-3">
                            <svg width="20" height="20" viewBox="0 0 24 24" onClick={()=>Reagirr()}>
                              <path
                  ...
                  ListComment.map((comment) => {
                    return Comment(comment.id,comment.text,comment.user,comment.date,data)
                  })}
                      </ul>
                      <form
                      ...
                      >
                        ...
                        <div className=" d-flex">
                            <svg   xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" onClick={()=>AddComment()}>
