      ...
      <Row>
                     ...
                     <div className="d-flex flex-wrap align-items-center justify-content-between">
                        <div className="d-flex flex-wrap align-items-center">
                           ...
                           <div className="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                              <h4 className="me-2 h4">Ali ben Salah</h4>
               ...
               <Tab.Pane eventKey="fourth" id="profile-profile">
                  <Card>
                     ...
                     <Card.Body>
                        <div className="text-center">
                           ...
                           <div className="mt-3">
                              <h3 className="d-inline-block">Ali Ben Salah</h3>
                              <p className="d-inline-block pl-3"> Footballer</p>
                  ...
                  <Card>
                     ...
                     <Card.Body>
                        ...
                        <p><Link to="#" className="text-body"> Footballer@odin.com</Link></p>
                        </div>
                        <div className="mt-2">
         ...
         <Col lg="3">
            <Card>
               ...
               <Card.Body>
                  <p>Manager Profile</p>
                  <div className="mb-1">Email: <Link to="#" className="ms-3">Footballer@odin.com</Link></div>
